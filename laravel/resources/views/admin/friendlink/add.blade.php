...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span><i class="icon-meter-medium"></i>友情链接添加</span>
    </div>
            ...
            <div class="mws-form-inline" style="width: 500px;">
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" class="small" value="{{old('linkname')}}" name="linkname">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">友情链接地址：</label>
                    <div class="mws-form-item">
                        <input type="text" class="small" value="{{old('url')}}" name="url">
                    </div>
                </div>
                <div class="mws-form-row">
