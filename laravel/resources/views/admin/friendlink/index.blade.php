...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-header">
    <span>
      <i class="icon-th-list"></i>友情链接列表</span>
  </div>
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
      <form action="/admin/friendlink/index">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 100px;">链接名称：</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 195px;">链接地址：</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 195px;">链接描述：</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 80px;">状态</th>
        ...
        @foreach($friendlinks as $k=>$v)
          <tr class="@if($k%2==0) even @else odd @endif">
            ...
            <td class=" "><a class="btn btn-info" href="/admin/friendlink/edit?id={{$v->id}}">修改</a><a class="btn btn-danger" href="/admin/friendlink/delete?id={{$v->id}}">删除</a></td>
           </tr>
        @endforeach
        </tbody>
      </table>
      ...
      <div id="pages">
      {!! $friendlinks->appends($request->all())->render() !!}      
    </div>
      </div>
  ...
  <script src="/admins/js/libs/jquery-1.8.3.min.js"></script>
    ...
    $(function(){
        $('.ibutton-container').click(function(){
            ...
            //发送
            $.get('/admin/friendlink/ajax-update', {status: status, id: id}, function(data){
                if(data == '1'){
                    alert('更新成功');
                }else{
                    alert('更新失败');
