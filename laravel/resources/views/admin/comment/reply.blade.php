...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-header">
    <span>
      <i class="icon-indent-left"></i>回复列表管理</span>
  </div>
  <div class="mws-panel-body no-padding">
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
      <form action="/admin/comment/answer">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 30px;">PID</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 81px;">评价的用户</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 100px;">评价用户的头像</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 100px;">评价的商品</th>
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 220px;">操作</th></tr>
        </thead>
        ...
        @foreach($comments as $k=>$v)
          <tr class="@if($k%2==0) even @else odd @endif">
            ...
            <td class=" ">
                  <span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>  
                  <img src="{{$v->user->profile}}" width="60" alt="">  
            </td>
            <td class=" ">{{$v->good->title}}</td>

            <td class=" "><input cid="{{$v->pid}}" class="ibutton" type="checkbox" @if($v->status) checked="checked" @endif></td>
            <td class=" "><a class="btn btn-info" href="/admin/comment/edit?id={{$v->pid}}">&nbsp;&nbsp;&nbsp;查  看  详  情&nbsp;&nbsp;</a>
                          <a class="btn btn-danger" href="/admin/comment/delete?id={{$v->pid}}">&nbsp;&nbsp; 删  除&nbsp;&nbsp;</a>
            </td>
           </tr>
        @endforeach
        </tbody>
...
@section('js')
  <script src="/admins/js/libs/jquery-1.8.3.min.js"></script>
    ...
    $('.ibutton-container').click(function(){
      ...
      //发送
      $.get('/admin/comment/ajax-update', {status: status, id: id}, function(data){
        if(data == '1'){
          alert('更新成功');
        }else{
          alert('更新失败');
