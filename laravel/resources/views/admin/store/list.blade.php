...
<div class="mws-panel grid_8">
  ...
  <div class="mws-panel-body no-padding">
    ...
    <form action="/admin/good/type-index">
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 30px;">库存ID</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 70px;">库存商品名称</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 40px;">库存商品销售信息</th>
...
<<<<<<< HEAD
                      <a href="/admin/store/detail?id={{$v->id}}" class="btn btn-small"><i class="icon-search"></i> 商品详情</a>
                      <a href="/admin/store/delete?id={{$v->id}}" class="btn btn-small" name="delete"><i class="icon-trash"></i>  删除</a>
=======
                      <a href="/admin/good/detail?id={{$v->id}}" class="btn btn-small"><i class="icon-search"></i> 商品详情</a>
